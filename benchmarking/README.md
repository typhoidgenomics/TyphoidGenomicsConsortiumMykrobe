...
Supplementary Figure 2: Average run-time of Typhi Mykrobe of 100 Typhi genomes 
The average run time for 100 Typhi genomes on three different computers. The number of threads used is shown on the x-axis. The average time (seconds per sample) to run on each genome is shown on the y axis. 
