...
genotypes_specified <- read_csv("https://raw.githubusercontent.com/typhoidgenomics/genotyphi/main/GenoTyphi_specification.csv") %>% head(n=87) # at time of paper there were 87 specified
