...
ggsave("Figure4_Cip_MIC.pdf", width=9, height=5)
ggsave("Figure4_CIP_MIC.png", width=9, height=5, units="in")
```
...
ggsave("Figure5_SEAP_AST.pdf", width=9, height=5)
ggsave("Figure5_SEAP_AST.png", width=9, height=5, units="in")
```
